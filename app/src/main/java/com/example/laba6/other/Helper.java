...
public class Helper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_STORE = "shop";
    private static final String KEY_ID = "id1";
    private static final String KEY_NAME = "name1";
    private static final String KEY_COUNT = "count1";
    private static final String KEY_DESCRIPTION = "description1";
    private static final String KEY_PRICE = "price1";
    ...
    public ProductModel getProduct(int id) {
        ...
        ProductModel model = new ProductModel(Integer.parseInt(cursor.getString(0)),
